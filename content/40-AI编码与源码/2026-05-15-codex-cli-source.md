...
> [📖 中英段落对照阅读](../99-工具与参考/ref-articles/codex-cli-bilingual.md)
...
- **包名**: `@openai/codex` (npm), `codex` (Homebrew)
...
- [[Agent 工程/终端 Agent 架构对比]] — 与 Gemini CLI、Kimi CLI 的安全模型对比
