...
author: ant-design
date: 2026-05-28
source: https://github.com/ant-design/x/blob/main/packages/x-sdk/README.md
tags:
  - react
  - ai-ui
  - ant-design-x
...
[Changelog](./CHANGELOG.md) 路 [Report a Bug][github-issues-bug-report] 路 [Request a Feature][github-issues-feature-request] 路 English 路 [涓枃](./README-zh_CN.md)
...
## 馃寛 Enterprise-level LLM Components Out of the Box
