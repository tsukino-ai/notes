---
title: EXAMPLES_SERVICE_PROVIDER
author: ant-design
date: 2026-05-28
source: https://github.com/ant-design/x/blob/main/packages/x-skill/skills-zh/x-request/reference/EXAMPLES_SERVICE_PROVIDER.md
tags:
  - react
  - ai-ui
  - ant-design-x
...
// const openAIRequest = XRequest('https://api.example-openai.com/v1/chat/completions', {
//   headers: {
//     'Authorization': 'Bearer sk-xxxxxxxx', // �?会暴露密�?
//   },
// });
