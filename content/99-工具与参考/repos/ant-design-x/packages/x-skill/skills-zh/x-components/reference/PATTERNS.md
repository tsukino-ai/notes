...
author: ant-design
date: 2026-05-28
source: https://github.com/ant-design/x/blob/main/packages/x-skill/skills-zh/x-components/reference/PATTERNS.md
tags:
  - react
  - ai-ui
  - ant-design-x
...
// Role config â€?keep STABLE (define outside component or useMemo)
const roles = {
  assistant: {
...
const commands = [
  { value: '/search', label: '/search â€?Search the web', icon: <SearchOutlined /> },
  { value: '/summarize', label: '/summarize â€?Summarize text', icon: <FileOutlined /> },
  { value: '/code', label: '/code â€?Generate code', icon: <CodeOutlined /> },
];
