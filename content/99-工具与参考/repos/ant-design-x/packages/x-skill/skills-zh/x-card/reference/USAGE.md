...
author: ant-design
date: 2026-05-28
source: https://github.com/ant-design/x/blob/main/packages/x-skill/skills-zh/x-card/reference/USAGE.md
tags:
  - react
  - ai-ui
  - ant-design-x
...
export default function StreamingDemo() {
  ...
  return (
    <div>
      <button onClick={startStream}>开�?/button>
      <XCard.Box commands={cmds} components={components}>
