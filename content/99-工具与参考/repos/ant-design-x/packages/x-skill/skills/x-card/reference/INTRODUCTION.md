...
author: ant-design
date: 2026-05-28
source: https://github.com/ant-design/x/blob/main/packages/x-skill/skills/x-card/reference/INTRODUCTION.md
tags:
  - react
  - ai-ui
  - ant-design-x
...
```
Agent (LLM) â†?A2UI Generator â†?Transport (SSE/WebSocket/A2A)
                    â†?
...
v0.8 uses implicit Surface creation â€?a Surface is automatically created when the Agent sends the first `updateComponents`:
...
### 1. createSurface â€?Create UI Container
...
### 2. updateComponents â€?Update Component Structure
...
### 3. updateDataModel â€?Update Data Model
...
### 4. deleteSurface â€?Delete Surface
...
Uses a flat component list instead of a nested tree structure â€?LLM-friendly, supports incremental updates, and fault-tolerant.
