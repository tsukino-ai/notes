---
title: A2UI Command Reference (v0.9)
author: ant-design
date: 2026-05-28
source: https://github.com/ant-design/x/blob/main/packages/x-skill/skills/x-card/reference/COMMANDS.md
tags:
  - react
  - ai-ui
  - ant-design-x
...
This file covers all four serverâ†’client commands in `XAgentCommand_v0_9`. Read this when you need to understand command structure or build a command sequence.
...
- One component must have `id: "root"` â€?this is the tree root
...
**Streaming pattern** â€?send structure first, then
