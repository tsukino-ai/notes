...
author: ant-design
date: 2026-05-28
source: https://github.com/ant-design/x/blob/main/packages/x-skill/skills/x-card/reference/USAGE.md
tags:
  - react
  - ai-ui
  - ant-design-x
...
```tsx
// ‚ú?Module-level constant ‚Ä?always stable
const COMPONENTS = { Text, Button, Column, Card };

// ‚ú?useMemo when deps are static
const components = useMemo(() => ({ Text, Button }), []);

// ‚ù?Inline object ‚Ä?recreated every render, causes Card to remount
