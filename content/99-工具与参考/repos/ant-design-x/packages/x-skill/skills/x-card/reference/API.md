...
author: ant-design
date: 2026-05-28
source: https://github.com/ant-design/x/blob/main/packages/x-skill/skills/x-card/reference/API.md
tags:
  - react
  - ai-ui
  - ant-design-x
...
```typescript
interface BoxProps {
  /** Command queue â€?append new commands; do NOT replace entire array on each update */
  commands?: (XAgentCommand_v0_9 | XAgentCommand_v0_8)[];
  /** Map of component name â†?React component implementation */
...
/** Load a catalog by ID â€?checks local registry first, then remote fetch */
