...
author: ant-design
date: 2026-05-28
source: https://github.com/ant-design/x/blob/main/packages/x/components/bubble/demo/list.md
tags:
  - react
  - ai-ui
  - ant-design-x
...
预设样式的气泡列表，支持自动滚动，支持使�?`role` 定义不同类别的气泡并设置属性�?*Bubble.List** 是一个受控组件，内部�?**Bubble** 做了 **memo** 处理，因此推荐使�?**setState** 的回调形式来修改 `items` 属性，尽可能保证非必要渲染数据项的配置稳定，以此来保证 **Bubble.List** 的高性能渲染�?
