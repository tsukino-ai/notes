...
author: ant-design
date: 2026-05-28
source: https://github.com/ant-design/x/blob/main/packages/x/components/bubble/demo/animation.md
tags:
  - react
  - ai-ui
  - ant-design-x
...
动画效果，仅支持 `content` 是字符串�?`contentRender` 渲染字符串的情况下生效。非字符串场景需要自定义渲染动画。生效时，如�?`content` 不变，而其他配置发生变化，动画不会重新执行�?
