---
title: Architecture Documentation: @mastra/voice-azure
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/voice/azure/architecture-llm.md
tags:
  - agent-framework
  - typescript
  - mastra
...
â”œâ”€â”€ extends MastraVoice (from @mastra/core)
â”œâ”€â”€ Dependencies
â”?  â”œâ”€â”€ microsoft-cognitiveservices-speech-sdk
â”?  â””â”€â”€ Node.js stream API
â”œâ”€â”€ Configuration
â”?  â”œâ”€â”€ speechModel (TTS configuration)
â”?  â””â”€â”€ listeningModel (STT configuration)
â””â”€â”€ Static Data
    â””â”€â”€ AZURE_VOICES (200+ voice definitions)
```
...
```
/src
  â”œâ”€â”€ index.ts          # Main AzureVoice class implementation
  â”œâ”€â”€ voices.ts         # Static voice definitions (~200+ voices)
  â””â”€â”€ index.test.ts     # Integration test suite
```
...
- Missing API key â†?throws immediately in constructor
- Missing region â†?throws immediately in constructor

### Runtime Errors

- Unconfigured models â†?throws on method call
- Empty input text â†?throws validation error
- Stream reading errors â†?wrapped and re-thrown
- Synthesis/recognition failures â†?detailed error messages with Azure reason codes
- Timeout protection â†?5-second timeout on synthesis
...
4. **listen() Tests**
   ...
   - Round-trip (speak â†?listen) verification
