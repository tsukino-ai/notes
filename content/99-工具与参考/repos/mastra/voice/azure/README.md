---
title: @mastra/voice-azure
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/voice/azure/README.md
tags:
  - agent-framework
  - typescript
  - mastra
...
‚ù?**Don't use generic names:**

```typescript
voiceName: 'neural'; // WRONG - not a valid voice
```

‚ú?**Use specific voice IDs:**

```typescript
voiceName: 'en-US-AriaNeural'; // CORRECT
```

‚ù?**Don't use wrong property names:**
...
‚ù?**Don't use Azure OpenAI credentials:**

```typescript
apiKey: process.env.AZURE_OPENAI_API_KEY; // WRONG
```

‚ú?**Use Azure Speech Services credentials:**
