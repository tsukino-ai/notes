---
title: @mastra/voice-inworld
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/voice/inworld/README.md
tags:
  - agent-framework
  - typescript
  - mastra
...
[Inworld AI](https://inworld.ai) voice provider for [Mastra](https://mastra.ai) â€?streaming TTS and batch STT.
...
const stream = await voice.speak('Hello', {
  ...
  temperature: 0.8, // (0, 2] â€?ignored on inworld-tts-2
  deliveryMode: 'CREATIVE', // STABLE | BALANCED | CREATIVE â€?only honored on inworld-tts-2
...
Set your API key via the `INWORLD_API_KEY` environment variable or pass it in the config. Get your key from [platform.inworld.ai](https://platform.inworld.ai) â†?Settings â†?API Keys.
