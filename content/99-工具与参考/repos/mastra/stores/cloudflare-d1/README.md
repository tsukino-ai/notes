---
title: @mastra/cloudflare-d1
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/stores/cloudflare-d1/README.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- `mastra_threads` â€?stores threads
- `mastra_messages` â€?stores messages
- `mastra_workflow_snapshot` â€?stores workflow snapshots
- `mastra_evals` â€?stores evaluations
- `mastra_traces` â€?stores traces
