...
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/stores/mssql/CHANGELOG.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- Add agents storage domain to MSSQL adapter â€?brings @mastra/mssql to parity with @mastra/mongodb and @mastra/libsql for the agents domain. The Studio "Agents" tab and `mastra.getEditor()` now work against MSSQL. ([#16376](https://github.com/mastra-ai/mastra/pull/16376))
...
- dependencies updates: ([#10197](https://github.com/mastra-ai/mastra/pull/10197))
  - Updated dependency [`mssql@^12.2.0` â†—ï¸Ž](https://www.npmjs.com/package/mssql/v/12.2.0) (from `^11.0.1`, in `dependencies`)
...
- 4230a13: dependencies updates:
  - Updated dependency [`mssql@^10.0.4` â†—ï¸Ž](https://www.npmjs.com/package/mssql/v/10.0.4) (from `^10.0.0`, in `dependencies`)
