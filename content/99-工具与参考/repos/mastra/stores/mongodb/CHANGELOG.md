---
title: @mastra/mongodb
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/stores/mongodb/CHANGELOG.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- dependencies updates: ([#10188](https://github.com/mastra-ai/mastra/pull/10188))
  - Updated dependency [`cloudflare@^5.2.0` â†—ï¸Ž](https://www.npmjs.com/package/cloudflare/v/5.2.0) (from `^4.5.0`, in `dependencies`)
...
- Added datasets and experiments storage support to the MongoDB store. ([#14556](https://github.com/mastra-ai/mastra/pull/14556))
  ...
  **Datasets** â€?Full dataset management with versioned items. Create, update, and delete datasets and their items with automatic version tracking. Supports batch insert/delete operations, time-travel queries to retrieve items at any past version, and item history tracking.

  **Experiments** â€?Run and track experiments against datasets. Full CRUD for experiments and per-item experiment results, with pagination, filtering, and cascade deletion.

  Both domains are automatically available when using `MongoDBStore` â€?no additional configuration needed.
...
- Added MCP client storage domain and ToolProvider interface for integrating external tool catalogs with stored agents. ([#12974](https://github.com/mastra-ai/mastra/pull/12974))
  ...
  **Tool Selection Semantics**
  ...
  - `{ tools: undefined }` â€?provider registered, no tools selected
  - `{ tools: {} }` â€?all tools from provider included
  - `{ tools: { 'TOOL_SLUG': { description: '...' } } }` â€?specific tools with optional overrides
...
- dependencies updates: ([#10114](https://github.com/mastra-ai/mastra/pull/10114))
  - Updated dependency [`uuid@^13.0.0` â†—ï¸Ž](https://www.npmjs.com/package/uuid/v/13.0.0) (from `^11.1.0`, in `dependencies`)

- dependencies updates: ([#10196](https://github.com/mastra-ai/mastra/pull/10196))
  - Updated dependency [`mongodb@^7.0.0` â†—ï¸Ž](https://www.npmjs.com/package/mongodb/v/7.0.0) (from `^6.17.0`, in `dependencies`)
...
- 9881232: dependencies updates:
  - Updated dependency [`cloudflare@^4.5.0` â†—ï¸Ž](https://www.npmjs.com/package/cloudflare/v/4.5.0) (from `^4.4.1`, in `dependencies`)
...
- 8e6b8e5: dependencies updates:
  - Updated dependency [`cloudflare@^4.4.1` â†—ï¸Ž](https://www.npmjs.com/package/cloudflare/v/4.4.1) (from `^4.3.0`, in `dependencies`)
...
- 63f6b7d: dependencies updates:
  - Updated dependency [`cloudflare@^4.3.0` â†—ï¸Ž](https://www.npmjs.com/package/cloudflare/v/4.3.0) (from `^4.1.0`, in `dependencies`)
  - Updated dependency [`mongodb@^6.17.0` â†—ï¸Ž](https://www.npmjs.com/package/mongodb/v/6.17.0) (from `^6.15.0`, in `dependencies`)
