...
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/stores/duckdb/README.md
tags:
  - agent-framework
  - typescript
  - mastra
...
| `euclidean`  | L2 distance       | 0-âˆ?(0 = identical) | Image embeddings, spatial data      |
| `dotproduct` | Inner product     | -âˆ?to âˆ?            | When magnitude matters              |
