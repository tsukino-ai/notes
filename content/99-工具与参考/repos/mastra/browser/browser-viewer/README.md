...
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/browser/browser-viewer/README.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- **Full screencast support** â€?Direct page-level CDP sessions
- **Input injection** â€?Mouse and keyboard events work correctly
- **Browser lifecycle control** â€?Browser starts/stops with the server
- **CLI flexibility** â€?Agent uses skills + workspace commands to drive any CLI
...
- **agent-browser** â€?Vercel's browser automation CLI (`--cdp <port>`)
- **browser-use** â€?Python-based browser automation (`--cdp-url <url>`)
- **browse-cli** â€?Browserbase's Stagehand CLI (`--ws <url>`)
