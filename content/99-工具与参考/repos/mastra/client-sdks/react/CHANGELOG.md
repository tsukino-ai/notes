...
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/client-sdks/react/CHANGELOG.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- dependencies updates: ([#13890](https://github.com/mastra-ai/mastra/pull/13890))
  - Updated dependency [`tailwind-merge@^3.5.0` â†—ï¸Ž](https://www.npmjs.com/package/tailwind-merge/v/3.5.0) (from `^3.4.1`, in `dependencies`)
...
- dependencies updates: ([#13308](https://github.com/mastra-ai/mastra/pull/13308))
  - Updated dependency [`tailwind-merge@^3.4.1` â†—ï¸Ž](https://www.npmjs.com/package/tailwind-merge/v/3.4.1) (from `^3.3.1`, in `dependencies`)
