---
title: Verifying Your Mastra Installation
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/docs/src/course/01-first-agent/03-verifying-installation.md
tags:
  - agent-framework
  - typescript
  - mastra
