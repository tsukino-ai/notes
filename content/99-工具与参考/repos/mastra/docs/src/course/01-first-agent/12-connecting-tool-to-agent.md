---
title: Connecting the Tool to Your Agent
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/docs/src/course/01-first-agent/12-connecting-tool-to-agent.md
tags:
  - agent-framework
  - typescript
  - mastra
