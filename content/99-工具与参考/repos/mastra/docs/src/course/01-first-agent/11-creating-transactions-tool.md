---
title: Creating the getTransactions Tool
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/docs/src/course/01-first-agent/11-creating-transactions-tool.md
tags:
  - agent-framework
  - typescript
  - mastra
