---
title: Enhancing Memory Configuration
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/docs/src/course/02-agent-tools-mcp/31-enhancing-memory-configuration.md
tags:
  - agent-framework
  - typescript
  - mastra
