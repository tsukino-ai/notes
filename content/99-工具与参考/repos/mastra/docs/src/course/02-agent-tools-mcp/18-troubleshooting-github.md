...
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/docs/src/course/02-agent-tools-mcp/18-troubleshooting-github.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- Missing or expired Personal Access Token â€?generate a new one at [GitHub Settings](https://github.com/settings/personal-access-tokens)
- Insufficient token permissions â€?ensure your token has read access to the repositories you're targeting
