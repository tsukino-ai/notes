---
title: Getting a Zapier MCP URL and API key
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/docs/src/course/02-agent-tools-mcp/08-getting-zapier-mcp-url.md
tags:
  - agent-framework
  - typescript
  - mastra
