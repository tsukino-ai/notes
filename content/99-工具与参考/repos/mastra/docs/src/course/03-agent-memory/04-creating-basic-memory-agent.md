---
title: Creating a Basic Memory Agent
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/docs/src/course/03-agent-memory/04-creating-basic-memory-agent.md
tags:
  - agent-framework
  - typescript
  - mastra
