---
title: Using Memory in Your Application
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/docs/src/course/03-agent-memory/09-using-memory-in-application.md
tags:
  - agent-framework
  - typescript
  - mastra
