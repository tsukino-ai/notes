---
title: Custom Working Memory Templates
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/docs/src/course/03-agent-memory/22-custom-working-memory-templates.md
tags:
  - agent-framework
  - typescript
  - mastra
