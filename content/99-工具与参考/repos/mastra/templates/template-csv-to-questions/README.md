---
title: CSV to Questions Generator
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/templates/template-csv-to-questions/README.md
tags:
  - agent-framework
  - typescript
  - mastra
...
This template shows how to combine agents into a workflow that can process large CSV files, generate summaries, and produce questionsâ€”all while keeping token usage efficient and costs down.
...
Swap in a different model, or wire the agent into your app using the [Mastra Client SDK](https://mastra.ai/docs/server/mastra-client). The agent, tools, and workflow are all in `src/` â€?edit them directly to fit your use case.
