---
title: @mastra/perplexity
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/integrations/perplexity/README.md
tags:
  - agent-framework
  - typescript
  - mastra
...
|--------|------|---------|-------------|
| `apiKey` | `string` | `PERPLEXITY_API_KEY` â†?`PPLX_API_KEY` | Perplexity API key. |
