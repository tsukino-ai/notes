---
title: @mastra/opencode
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/integrations/opencode/CHANGELOG.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- Fixed npm publish for @mastra/opencode â€?the dist/ folder was missing because turbo couldn't find a build task to run. Added turbo.json so the build:lib script runs correctly during CI. ([#13064](https://github.com/mastra-ai/mastra/pull/13064))
