...
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/workspaces/blaxel/README.md
tags:
  - agent-framework
  - typescript
  - mastra
...
| `env`      | `Record<string, string>`              | â€?                           | Environment variables to set in the sandbox            |
| `labels`   | `Record<string, string>`              | â€?                           | Custom labels for the sandbox                          |
| `runtimes` | `SandboxRuntime[]`                    | `['node', 'python', 'bash']` | Supported runtimes                                     |
| `ports`    | `Array<{ name?, target, protocol? }>` | â€?                           | Ports to expose from the sandbox                       |
