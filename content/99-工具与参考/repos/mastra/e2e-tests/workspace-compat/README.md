---
title: Workspace Version Compatibility E2E Test
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/e2e-tests/workspace-compat/README.md
tags:
  - agent-framework
  - typescript
  - mastra
...
1. **Matching versions** - Both core and client support workspace v1 â†?`isSupported: true`
2. **Old core** (simulated) - Core missing `workspaces-v1` feature â†?`isSupported: false`
3. **Old client** (simulated) - Client missing workspace methods â†?`isSupported: false`
