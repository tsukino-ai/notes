---
title: Picker Allowlists (Tools / Agents / Workflows)
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/.claude/skills/builder-smoke-test/references/picker-allowlist.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- [ ] Workflows without `inputSchema` either appear with a warning or are hidden â€?note which
