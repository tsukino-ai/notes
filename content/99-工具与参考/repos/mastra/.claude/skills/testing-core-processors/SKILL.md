---
title: Testing Core Error Processors
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/.claude/skills/testing-core-processors/SKILL.md
tags:
  - agent-framework
  - typescript
  - mastra
...
2. **Control test**: Same scenario without the processor â€?error propagates
...
- `ANTHROPIC_API_KEY` â€?for testing against real Anthropic API
- `OPENROUTER_API_KEY` â€?for testing provider switching scenarios
