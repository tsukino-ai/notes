---
title: Cloud Advanced Testing
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/.claude/skills/mastra-smoke-test/references/cloud-advanced.md
tags:
  - agent-framework
  - typescript
  - mastra
...
1. Navigate to deployed Studio â†?Settings â†?API Keys
...
| ----------- | ------------- | ------------------------------------ | ------ |
| **BYOK**    | Header key    | Agent uses key from header           | â¬?    |
| **BYOK**    | Settings key  | Agent uses key from project settings | â¬?    |
| **Storage** | DB connector  | Project works with selected DB       | â¬?    |
| **Storage** | Data persists | Data survives server restart         | â¬?    |
