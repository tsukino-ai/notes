---
title: Agents Testing (`--test agents`)
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/.claude/skills/mastra-smoke-test/references/tests/agents.md
tags:
  - agent-framework
  - typescript
  - mastra
...
`/generate` â€?these are silently discarded. Use `memory: { thread, resource }`.
