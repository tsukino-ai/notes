---
title: Error Handling Testing (`--test errors`)
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/.claude/skills/mastra-smoke-test/references/tests/errors.md
tags:
  - agent-framework
  - typescript
  - mastra
...
against â€?flag any deviation as a regression.
