---
title: Scorers Testing (`--test scorers`)
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/.claude/skills/mastra-smoke-test/references/tests/scorers.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- Treating `POST /api/scores/scorers/<id>/execute` as real â€?it does not
  ...
  result.
- Expecting scorers to run on ad-hoc text input â€?they need a live
  agent/workflow run.
