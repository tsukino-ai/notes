---
title: Traces Testing (`--test traces`)
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/.claude/skills/mastra-smoke-test/references/tests/traces.md
tags:
  - agent-framework
  - typescript
  - mastra
...
`{ pagination: { total, page, perPage, hasMore }, spans: [...] }` â€?**not**
