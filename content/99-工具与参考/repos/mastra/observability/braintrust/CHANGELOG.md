---
title: @mastra/braintrust
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/observability/braintrust/CHANGELOG.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- dependencies updates: ([#11646](https://github.com/mastra-ai/mastra/pull/11646))
  - Updated dependency [`braintrust@^2.2.0` â†—ï¸Ž](https://www.npmjs.com/package/braintrust/v/2.2.0) (from `^1.1.0`, in `dependencies`)
...
- dependencies updates: ([#10107](https://github.com/mastra-ai/mastra/pull/10107))
  - Updated dependency [`braintrust@^0.4.9` â†—ï¸Ž](https://www.npmjs.com/package/braintrust/v/0.4.9) (from `^0.4.3`, in `dependencies`)
...
- dependencies updates: ([#11389](https://github.com/mastra-ai/mastra/pull/11389))
  - Updated dependency [`braintrust@^1.1.0` â†—ï¸Ž](https://www.npmjs.com/package/braintrust/v/1.1.0) (from `^0.4.9`, in `dependencies`)
...
- dependencies updates: ([#8098](https://github.com/mastra-ai/mastra/pull/8098))
  - Updated dependency [`braintrust@^0.3.8` â†—ï¸Ž](https://www.npmjs.com/package/braintrust/v/0.3.8) (from `^0.3.6`, in `dependencies`)
