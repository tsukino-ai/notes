---
title: @mastra/langsmith
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/observability/langsmith/CHANGELOG.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- dependencies updates: ([#10151](https://github.com/mastra-ai/mastra/pull/10151))
  - Updated dependency [`langsmith@>=0.3.79` â†—ï¸Ž](https://www.npmjs.com/package/langsmith/v/0.3.79) (from `>=0.3.72`, in `dependencies`)
...
- dependencies updates: ([#8560](https://github.com/mastra-ai/mastra/pull/8560))
  - Updated dependency [`langsmith@>=0.3.72` â†—ï¸Ž](https://www.npmjs.com/package/langsmith/v/0.3.72) (from `>=0.3.71`, in `dependencies`)
...
- dependencies updates: ([#8317](https://github.com/mastra-ai/mastra/pull/8317))
  - Updated dependency [`langsmith@>=0.3.71` â†—ï¸Ž](https://www.npmjs.com/package/langsmith/v/0.3.71) (from `>=0.3.69`, in `dependencies`)
