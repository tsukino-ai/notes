---
title: Hono Multi-Service Example
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/observability/_examples/otel-bridge/hono-multi/README.md
tags:
  - agent-framework
  - typescript
  - mastra
...
service-two (port 3001)
    â†?HTTP request
service-mastra (port 4000) â†?Mastra agent with OtelBridge
```
...
```json
{
  "message": "service-one â†?service-two â†?service-mastra (agent: Hello there friend!)"
}
```
