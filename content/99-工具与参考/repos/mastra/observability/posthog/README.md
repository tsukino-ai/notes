---
title: @mastra/posthog
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/observability/posthog/README.md
tags:
  - agent-framework
  - typescript
  - mastra
...
{
  metadata: {
    userId: 'user-123',      // â†?distinctId in PostHog
    sessionId: 'session-abc', // â†?$ai_session_id for grouping
...
1. Navigate to **Product Analytics** â†?**Events**
