---
title: @mastra/langfuse
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/observability/langfuse/CHANGELOG.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- Added new attribute mappings to the Langfuse exporter so more Mastra attributes are filterable in Langfuse's UI. ([#15445](https://github.com/mastra-ai/mastra/pull/15445))
  ...
  **Observation-level metadata** â€?`gen_ai.agent.id`, `gen_ai.agent.name`, `mastra.span.type`, and `gen_ai.operation.name` are now mapped to `langfuse.observation.metadata.*`, making them top-level filterable keys on each observation. This lets you scope Langfuse evaluators to specific agents or span types.

  **Trace-level attributes** â€?`mastra.metadata.traceName` and `mastra.metadata.version` are now mapped to `langfuse.trace.name` and `langfuse.trace.version`, enabling custom trace names and version-based filtering.
...
- dependencies updates: ([#10149](https://github.com/mastra-ai/mastra/pull/10149))
  - Updated dependency [`langfuse@^3.38.6` â†—ï¸Ž](https://www.npmjs.com/package/langfuse/v/3.38.6) (from `^3.38.5`, in `dependencies`)
...
- dependencies updates: ([#7714](https://github.com/mastra-ai/mastra/pull/7714))
  - Updated dependency [`langfuse@^3.38.5` â†—ï¸Ž](https://www.npmjs.com/package/langfuse/v/3.38.5) (from `^3.38.4`, in `dependencies`)
