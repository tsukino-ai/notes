...
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/packages/codemod/.claude/skills/codemod-patterns/SKILL.md
tags:
  - agent-framework
  - typescript
  - mastra
...
Example mastra.getScorers() â†?mastra.listScorers()
...
Example @mastra/evals/scorers/llm â†?@mastra/evals/scorers/prebuilt
...
Example runExperiment â†?runEvals
...
Example MastraMessageV2 â†?MastraDBMessage
...
Example memory.recall({ vectorMessageSearch }) â†?memory.recall({ vectorSearchString })
...
Example PostgresStore schema â†?schemaName
...
Example context.runCount â†?context.retryCount in step execution
...
Example new PgVector(connectionString) â†?new PgVector({ connectionString })
...
Problem Need to rename multiple parameters in the same call (e.g., offset â†?page AND limit â†?perPage)
...
â”€ codemods/
â””â”€â”€ v1/
â””â”€â”€ <codemod-name>.ts
â”€ test/
â”œâ”€â”€ **fixtures**/
â”?â”œâ”€â”€ <codemod-name>.input.ts
â”?â””â”€â”€ <codemod-name>.output.ts
â””â”€â”€ <codemod-name>.test.ts
â”€ lib/
â”€ bundle.ts # Auto-updated
