...
author: mastra-ai
date: 2026-05-28
source: https://github.com/mastra-ai/mastra/blob/main/packages/playground-ui/CLAUDE.md
tags:
  - agent-framework
  - typescript
  - mastra
...
- use `playground-msw-tests` skill â€?PRIMARY testing strategy for components and hooks
...
2. **Playwright E2E** â€?`e2e-tests-studio` skill. Use only when MSW cannot
   model the journey.
